<div class="bookwize-integrated theme-d">
    ...
    <div id="Header" data-template="<?php echo BW_PUBLIC_URL; ?>public/partials/templates/header_a.html"></div>
    <div id="ReservationContainer" class="reservation-container">
        ...
        <section data-template="<?php echo BW_PUBLIC_URL; ?>public/partials/templates/step1_d.html" id="Step1">
        </section>
        <section data-template="<?php echo BW_PUBLIC_URL; ?>public/partials/templates/step2_c.html" id="Step2">
        </section>
        <section data-template="<?php echo BW_PUBLIC_URL; ?>public/partials/templates/step3_b.html" id="Step3">
        </section>
        <section data-template="<?php echo BW_PUBLIC_URL; ?>public/partials/templates/step4_b.html" id="Step4">
        </section>
    </div>
