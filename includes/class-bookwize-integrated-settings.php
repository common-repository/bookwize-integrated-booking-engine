		...
		$this->settings = [
			...
			[
				...
				'settings' => [
                    ...
                    ['bw_adwordsTrack', 'Include Adwords Tracking Code?', 'text', '<b>Caution:</b> Only numbers'],
                    ['bw_facebookTrack', 'Include Facebook Tracking Code?', 'text', ''],
				],
			],
			[
				'name'     => 'configuration',
				'section'  => [ 'configuration_section', 'Configuration' ],
				'settings' => [
					['bw_disable_bootstrap', 'Disable Bootstrap css', 'checkbox', 'Click this to disable bootstrap.css ( this might cause design to break )'],
					['bw_disable_fontawesome', 'Disable Fontawesome', 'checkbox', 'Click this to disable fontawesome.css']
